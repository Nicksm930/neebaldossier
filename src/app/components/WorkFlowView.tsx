...
export default function WorkFlowView({ data }: { data: any }) {
  ...
  const renderReport = (report: string | Record<string, any>) => {
    ...
    if (typeof report === "string") {
      return (
        <div className="prose prose-sm max-w-none text-gray-700 text-md">
          ...
          {Object.entries(report).map(([key, value]) => (
            <div key={key} className="flex flex-col">
              ...
              {typeof value === "object" && value !== null ? (
                ...
                <div className="prose prose-sm max-w-none mt-2 text-gray-700 text-md">
      ...
      <div className="bg-white shadow-lg hover:shadow-xl rounded-2xl p-8 transition duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700 text-lg">
          ...
          <div className="md:col-span-2">
            ...
            <div className="prose prose-sm bg-gray-50 p-4 mt-2 rounded-md text-gray-600 whitespace-pre-wrap shadow-inner">
